...
var SortFunctions = {
  ...
  date: function compareDates(a, b) {
    return (0, _moment2.default)(a).isAfter((0, _moment2.default)(b)) ? 1 : -1;
  }
};
...
var Table = function (_React$Component) {
  ...
  function Table(props) {
    ...
    _this.state = {
      selection: _this.getSelection(props),
  ...
  _createClass(Table, [{
    ...
    value: function shouldComponentUpdate(nextProps, nextState) {
      return !(0, _immutable.is)(this.state.selection, nextState.selection) || !Object.is(this.state.sortBy, nextState.sortBy) || !(0, _immutable.is)(this.props.data, nextProps.data) || !(0, _immutable.is)(this.props.columns, nextProps.columns) || !(0, _immutable.is)(this.props.value, nextProps.value) || this.props.className !== nextProps.className;
    }
  }, {
    key: 'getSelection',
    value: function getSelection() {
      ...
      if (!props.value) {
        return this.state && this.state.selection || new _immutable.OrderedMap();
      }
      var selection = new _immutable.OrderedMap();
      selection = selection.withMutations(function (sel) {
        // map props.value keys to props.data objects
        props.value.forEach(function (key) {
          var row = props.data.find(function (o) {
            return o.key === key;
          });
          if (row) {
            sel = sel.set(key, row);
    ...
    value: function clear(event) {
      ...
      this.setState({
        ...
        _this2.props.onSelect(_this2.state.selection, event);
      });
    }
    ...
    key: 'handleMetaClick',
    value: function handleMetaClick(row, isSelected) {
      if (isSelected) {
        // remove row
    ...
    value: function handleShiftClick(row, rowIndex) {
      var _this3 = this;

      var last = this.state.selection.last();
      ...
      var start = sortedData.findIndex(function (o) {
        return o.key === last.key;
      });
      // end with the row just clicked
      var end = rowIndex;
      // the "direction" user is selecting in
      var selectDirection = start > end ? 'up' : 'down';
      ...
      var functionName = slice.some(function (_row) {
        return !_this3.isSelected(_row);
      }) ? 'set' : 'delete';
      slice.forEach(function (_row) {
    ...
    key: 'handleRowClick',
    value: function handleRowClick(row, rowIndex, isSelected, event) {
      var _this4 = this;
      ...
      this.setState({
        ...
        if (typeof _this4.props.onSelect === 'function') {
          _this4.props.onSelect(_this4.state.selection, event);
        }
      });
    }
    ...
    key: 'handleRowDelete',
    value: function handleRowDelete(row, rowIndex, isSelected, event) {
    ...
    key: 'handleSort',
    value: function handleSort(columnKey) {
      var _this5 = this;
      ...
      this.setState({
        ...
        if (typeof _this5.props.onSort === 'function') {
          _this5.props.onSort(_this5.state.sortBy);
        }
        if (typeof _this5.props.onSelect === 'function') {
          _this5.props.onSelect(_this5.state.selection);
        }
      });
    }
    ...
    value: function getSortedData() {
      ...
      var columnKey = this.state.sortBy.column;
      ...
      var columnSort = this.props.columns.get(columnKey).sort;
      var useCustomSort = typeof columnSort === 'function';
      var compare = useCustomSort ? columnSort : SortFunctions[columnSort];
      if (typeof compare !== 'function') {
        console.error('ship-components-table sorting requires a function.');
        return this.extractData();
      }
      var data = this.extractData().sort(function (a, b) {
        if (!_this6.state.sortBy.ascending) {
          var tmp = a;
          a = b;
          b = tmp;
        }
    ...
    key: 'getSortIcon',
    value: function getSortIcon(columnKey) {
      if (this.state.sortBy.column === columnKey) {
        if (this.state.sortBy.ascending) {
          return _react2.default.createElement('span', { className: _shipComponentsIcon2.default.keyboard_arrow_down });
        } else {
          return _react2.default.createElement('span', { className: _shipComponentsIcon2.default.keyboard_arrow_up });
        }
      }
      // returning this hidden icon preserves whitespace and prevents minor width changes in columns.
      return _react2.default.createElement('span', { className: (0, _classnames2.default)(_Table2.default.hidden, _shipComponentsIcon2.default.keyboard_arrow_up) });
    }
    ...
    value: function handleDoubleClick(event) {
      ...
      var rowKey = event.target.dataset.rowKey;
      ...
      if (rowKey && typeof this.props.onDoubleClick === 'function') {
        var row = this.props.data.find(function (o) {
          return o.key.toString() === rowKey;
        });
    ...
    value: function render() {
      ...
      var columnKeys = this.props.columns.keySeq();
      return _react2.default.createElement(_shipComponentsOutsideclick2.default, {
        ref: 'container',
        className: (0, _classnames2.default)(this.props.className, _Table2.default.container),
        onClick: this.handleBlur
      }, _react2.default.createElement('ul', { className: _Table2.default.head }, columnKeys.map(function (key) {
        var column = _this7.props.columns.get(key);
        return _react2.default.createElement('li', {
          key: key,
          style: column.style,
          onClick: _this7.handleSort.bind(_this7, key),
          className: (0, _classnames2.default)(_Table2.default.headCell, _Table2.default[key])
        }, column.label, _this7.getSortIcon.call(_this7, key));
      })), _react2.default.createElement('ul', {
        className: _Table2.default.body,
        onDoubleClick: this.handleDoubleClick
      }, this.getSortedData().map(function (row, index) {
        return _react2.default.createElement(_TableRow2.default, {
          key: row.key,
          row: row,
          rowIndex: index,
          columns: _this7.props.columns,
          selected: _this7.isSelected(row),
          onClick: _this7.handleRowClick,
          onDelete: _this7.handleRowDelete,
          deletable: _this7.props.deletable
        });
      })));
    }
  }]);
...
Table.defaultProps = {
  className: '',
  columns: new _immutable.OrderedMap(),
...
Table.propTypes = {
  ...
  columns: _propTypes2.default.instanceOf(_immutable.OrderedMap).isRequired,
  data: _propTypes2.default.instanceOf(_immutable.List).isRequired,
  value: _propTypes2.default.instanceOf(_immutable.Seq.Indexed),
  dataExtractor: _propTypes2.default.func,
...
module.exports = require("ship-components-outsideclick");
...
var _TableRow = __webpack_require__(140);
...
function DataViewRow(props) {
  var row = props.row,
      columns = props.columns;

  var columnKeys = columns.keySeq();
  var handleClick = function handleTableRowClick(event) {
    props.onClick(row, props.rowIndex, props.selected, event);
  };
  return _react2.default.createElement('li', {
    'data-row-key': row.key,
    className: (0, _classnames2.default)(_TableRow2.default.row, _defineProperty({}, _TableRow2.default.selected, props.selected)),
    onClick: handleClick
  }, columnKeys.map(function (_key) {
    var column = props.columns.get(_key);
    return _react2.default.createElement('div', {
      key: _key + '-' + row.key,
      style: column.style,
      className: (0, _classnames2.default)(_TableRow2.default.cell, _TableRow2.default[_key])
    }, row[_key]);
  }), props.deletable ? _react2.default.createElement('button', { className: (0, _classnames2.default)('icon', 'request-button', 'btn', 'btn-flat', 'btn-icon-effect-loading'), type: 'button', onClick: props.onDelete.bind(this) }, _react2.default.createElement('span', { className: (0, _classnames2.default)('icon') }), _react2.default.createElement('span', { className: 'btn-value' }, _react2.default.createElement('span', { className: 'icon-cross' }))) : null);
}
...
module.exports = {"row":"TableRow--row","selected":"TableRow--selected","cell":"TableRow--cell","name":"TableRow--name","title":"TableRow--title"};
...
// removed by extract-text-webpack-plugin
module.exports = {"container":"Table--container","hidden":"Table--hidden","head":"Table--head","body":"Table--body","headCell":"Table--headCell"};
